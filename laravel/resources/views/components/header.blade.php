    ...
    <div class="vc-container vc-nav">
        ...
        <nav class="vc-nav__links" aria-label="Main Navigation">
            ...
            <div class="vc-dropdown">
                <button class="vc-nav__link" style="display: flex; align-items: center; gap: 0.25rem; border: none; background: none; cursor: pointer; padding: 0;">
                    Treatments <span style="font-size: 0.75rem; transition: transform 0.2s;">▼</span>
                </button>
                <div class="vc-mega-menu-wrapper">
                    <div class="vc-mega-menu">
                        <div class="vc-mega-menu-grid">
                            <a href="{{ url('/laparoscopy') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?auto=format&fit=crop&w=150&q=80" alt="Laparoscopy">
                            ...
                            <a href="{{ url('/hernia') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1551601651-2a8555f1a136?auto=format&fit=crop&w=150&q=80" alt="Hernia Surgery">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/hemorrhoids') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?auto=format&fit=crop&w=150&q=80" alt="Laser Piles">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/gallbladder') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=150&q=80" alt="Gallbladder">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/appendicitis') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=150&q=80" alt="Appendicitis">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/endoscopy') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1471864190281-a93a3070b6de?auto=format&fit=crop&w=150&q=80" alt="Endoscopy">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/breast-surgery') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=150&q=80" alt="Breast Surgery">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/thyroid') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1530026405186-ed1ea0ac7a63?auto=format&fit=crop&w=150&q=80" alt="Thyroid Surgery">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/fistula') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?auto=format&fit=crop&w=150&q=80" alt="Fistula Treatment">
                                <div class="vc-mega-menu-info">
                            ...
                            <a href="{{ url('/fissure') }}" class="vc-mega-menu-tile">
                                <img class="vc-mega-menu-thumb" src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=150&q=80" alt="Fissure Treatment">
                                <div class="vc-mega-menu-info">
        ...
        <div class="vc-cluster" style="align-items: center; gap: var(--space-4);">
            ...
            <a href="tel:07447441426" class="vc-btn vc-btn--outline vc-btn--sm desktop-only" style="display: inline-flex; align-items: center; gap: 0.25rem;">
                ...
                <span style="font-weight:600;">+91 7447441426</span>
            </a>
...
<style>
    ...
    @media (min-width: 768px) {
        .vc-dropdown:hover .vc-mega-menu-wrapper {
            display: block !important;
        }
        .vc-dropdown:hover button span {
